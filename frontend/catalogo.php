...
<body class="catalogo-page">
    ...
    <div class="container">
        <div class="slider">
            <ul>
                <li><img src="img/catalogo/oferta1.webp" alt="Oferta 1"></li>
                <li><img src="img/catalogo/oferta3.jpg" alt="Oferta 3"></li>
                <li><img src="img/catalogo/oferta1.1.webp" alt="Oferta 1.1"></li>
                <li><img src="img/catalogo/oferta3.1.jpg" alt="Oferta 3.1"></li>
            </ul>
        </div>
