document.addEventListener("DOMContentLoaded", function() {
    ...
    errorContainer.id = "error-mensaje-admin-editar";
    ...
    // Buscar el contenedor del botón si existe
    const submitContainer = submitButton ? (submitButton.closest('.form-group') || submitButton) : null;
    ...
    if (submitContainer && submitContainer.parentNode === form) {
        ...
        // Fallback si no encuentra botón (raro)
    ...
    form.addEventListener("submit", function(e) {
        ...
        // 3. Validar Contraseña (OPCIONAL en edición)
